...
xv_path="D:/Programs/Vivado/Vivado/2016.3"
...
{
  file="xsim.ini"
  lib_map_path="D:/Programs/Vivado/Vivado/2016.3/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
